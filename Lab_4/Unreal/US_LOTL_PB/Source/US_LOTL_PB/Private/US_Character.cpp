...
{
	GEngine->AddOnScreenDebugMessage(2, 5.0f, FColor::Blue, TEXT("SprintStart"));
...
{
	GEngine->AddOnScreenDebugMessage(2, 5.0f, FColor::Blue, TEXT("SprintEnd"));
...
{
	GEngine->AddOnScreenDebugMessage(3, 5.0f, FColor::Red, TEXT("Interact"));
